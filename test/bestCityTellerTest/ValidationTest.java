...
import utilitiesTest.CityOfTweetsExpertTest;
...
public class ValidationTest {
	...
	@Test
	public void getCandidateCities1Test() throws ClassNotFoundException, SQLException {
	...
	public void getCandidateCities2Test() throws ClassNotFoundException, SQLException {
		...
		City2Score city2Score = teller.getCandidateCities().stream().findFirst().get();
		String result = city2Score.getCity().toString();
